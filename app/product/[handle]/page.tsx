...
async function RelatedProducts({ id }: { id: string }) {
  ...
  return (
    <div className='py-8'>
      <h2 className='mb-4 text-xl font-medium'>Related Products</h2>
      <ul className='flex w-full gap-4 overflow-x-auto pt-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden'>
